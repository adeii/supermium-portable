...
func vivaldiLnk() (*asset, error) {
	bytes, err := vivaldiLnkBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "Vivaldi.lnk", size: 2175, mode: os.FileMode(0666), modTime: time.Unix(1688851431, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Vivaldi.lnk": {vivaldiLnk, map[string]*bintree{}},
}}
