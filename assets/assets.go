...
func supermiumLnk() (*asset, error) {
	bytes, err := supermiumLnkBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "Supermium.lnk", size: 2175, mode: os.FileMode(0666), modTime: time.Unix(1688851431, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Supermium.lnk": {supermiumLnk, map[string]*bintree{}},
}}
