...
func operaLnk() (*asset, error) {
	bytes, err := operaLnkBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "Opera.lnk", size: 2175, mode: os.FileMode(0666), modTime: time.Unix(1662905472, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"Opera.lnk": {operaLnk, map[string]*bintree{}},
}}
